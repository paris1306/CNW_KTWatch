...
<div>
	<div>
	<h3 style="font-family: cursive;margin-left: 10px; margin-top: 0px" >Quản Lý Đơn Hàng đã hủy {{-- &nbsp;/&nbsp;{{count($hd)}} Đơn Hàng --}}</h3>
	...
	<br><br><br>
	{{-- <button class="btn btn-danger float-right" style="margin-right: 7px; margin-left: 10px"><a href="" target="_blank" style="color: white;text-decoration: none;float: left;">Hóa đơn đã hủy</a></button> --}}
