...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ route('homeadmin') }}" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>KT</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="public/image/icon/tk.png" class="user-image" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{ route('qltv') }}"><i class="fa fa-laptop"></i> <span>Quản Lý Thành Viên</span></a></li>
        <li><a href="{{ route('qlcomment') }}"><i class="glyphicon glyphicon-comment"></i> <span>Quản Lý Comment</span></a></li>
        ...
        <li><a href="{{ route('qltt') }}"><i class="fa fa-th"></i> <span>Tin Tức</span></a></li>
